...
//===================================工厂师傅接口===============================================
let GetComplaintListByOrderId=BASE_URL2+"Order/GetComplaintListByOrderId"//MARK:获取工单投诉列表
let GetOrderInfoList2=BASE_URL2+"Order/GetOrderInfoList2"//MARK:获取工单列表
...
let ApproveAuth=BASE_URL2+"Account/ApproveAuth"//审核实名
let ConfirmWithDraw=BASE_URL2+"Account/ConfirmWithDraw"//提现成功
let GetIDCardImg=BASE_URL2+"Account/GetIDCardImg"//获取用户实名照片
let GetMUserList=BASE_URL2+"Account/GetMUserList"//获取师傅账号列表
let GetWithDrawList=BASE_URL2+"Account/GetWithDrawList"//获取提现列表
let UploadAvator=BASE_URL2+"Upload/UploadAvator"//MARK:上传头像
let GetCode=BASE_URL2+"Message/Send"//发送验证码
...
let CloseOrder=BASE_URL2+"Order/CloseOrder"//关闭工单 结算
let modifyOrderMoney=BASE_URL2+"Order/modifyOrderMoney"//修改工单金额
...
let GetOrderPayByOrderID=BASE_URL2+"Pay/GetOrderPayByOrderID"//工单支付记录
...
let SalesToday=BASE_URL2+"Order/SalesToday"//MARK:获取统计数据
let SalesToday2=BASE_URL2+"Order/SalesToday2"//MARK:获取统计数据
let SalesToday3=BASE_URL2+"Order/SalesToday3"//MARK:获取统计数据
let SendOrder=BASE_URL2+"Order/SendOrder"//MARK:派单 TypeId:操作：1指定派单2改派工单
